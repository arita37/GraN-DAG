...
CODE_PATH="~/go/src/github.com/GraN-DAG"  # path to the code root
EXP_PATH="~/go/src/github.com/GraN-DAG/experiments"  # this folder will contain all artifacts saved by the program
DATA_PATH="~/go/src/github.com/GraN-DAG/data/data_p10_e10_n1000_GP"  # this should contain (data1.npy, DAG1.npy, CPDAG1.npy), (data2.npy, DAG2.npy, CPDAG2.npy), ...
